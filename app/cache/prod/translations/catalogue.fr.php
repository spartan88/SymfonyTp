...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    ...
    'titre.length.min' => 'Le titre ne peut en comporter moins de {{ limit }}',
  ...
  array (
    ...
    'site.user.login' => 'Connecté en tant que %login% !',
    'site.devise' => 'Ce projet est propulsé par Symfony2, et construit grâce au MOOC OpenClassrooms et SensioLabs.
',
