...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/js/766634f')) {
            // _assetic_766634f
            if ($pathinfo === '/js/766634f.js') {
                return array (  '_controller' => 'assetic.controller:render',  'name' => '766634f',  'pos' => NULL,  '_format' => 'js',  '_route' => '_assetic_766634f',);
            }

            if (0 === strpos($pathinfo, '/js/766634f_')) {
                if (0 === strpos($pathinfo, '/js/766634f_part_1_')) {
                    // _assetic_766634f_0
                    if ($pathinfo === '/js/766634f_part_1_fonction_1.js') {
                        return array (  '_controller' => 'assetic.controller:render',  'name' => '766634f',  'pos' => 0,  '_format' => 'js',  '_route' => '_assetic_766634f_0',);
                    }

                    if (0 === strpos($pathinfo, '/js/766634f_part_1_jquery-')) {
                        // _assetic_766634f_1
                        if ($pathinfo === '/js/766634f_part_1_jquery-2.1.3.min_2.js') {
                            return array (  '_controller' => 'assetic.controller:render',  'name' => '766634f',  'pos' => 1,  '_format' => 'js',  '_route' => '_assetic_766634f_1',);
                        }

                        // _assetic_766634f_2
                        if ($pathinfo === '/js/766634f_part_1_jquery-ui.min_3.js') {
                            return array (  '_controller' => 'assetic.controller:render',  'name' => '766634f',  'pos' => 2,  '_format' => 'js',  '_route' => '_assetic_766634f_2',);
                        }
                ...
                // _assetic_766634f_3
                if ($pathinfo === '/js/766634f_ckeditor_2.js') {
                    return array (  '_controller' => 'assetic.controller:render',  'name' => '766634f',  'pos' => 3,  '_format' => 'js',  '_route' => '_assetic_766634f_3',);
                }
        ...
        // oc_platform_home
        if (preg_match('#^/(?P<_locale>en|fr)/platform(?:/(?P<page>\\d*)(?:/(?P<nbPerPage>\\d*))?)?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_home')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::indexAction',  'page' => 1,  'nbPerPage' => 1,));
        }

        // oc_platform_view
        if (preg_match('#^/(?P<_locale>en|fr)/platform/advert/(?P<advert_id>\\d+)$#s', $pathinfo, $matches)) {
        ...
        // oc_platform_test
        if (preg_match('#^/(?P<_locale>en|fr)/platform/test$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'oc_platform_test')), array (  '_controller' => 'OC\\PlatformBundle\\Controller\\AdvertController::testAction',));
        }

        // oc_platform_paramconverter
        if (preg_match('#^/(?P<_locale>en|fr)/platform/test/(?P<json>[^/]++)$#s', $pathinfo, $matches)) {
