...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'oc_platform.beta.html' => 'getOcPlatform_Beta_HtmlService',
            'oc_platform.beta.listener' => 'getOcPlatform_Beta_ListenerService',
            'oc_platform.censorship_listener' => 'getOcPlatform_CensorshipListenerService',
            'oc_platform.censorship_processor' => 'getOcPlatform_CensorshipProcessorService',
            'oc_platform.ckeditor' => 'getOcPlatform_CkeditorService',
            'oc_platform.datepicker' => 'getOcPlatform_DatepickerService',
            'oc_platform.doctrine.notification' => 'getOcPlatform_Doctrine_NotificationService',
            'oc_platform.json_paramconverter' => 'getOcPlatform_JsonParamconverterService',
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor.jar'), 'C:\\dev\\java\\jdk\\jdk8-x86\\bin\\java.exe');
    ...
    {
        $this->services['assetic.filter.yui_js'] = $instance = new \Assetic\Filter\Yui\JsCompressorFilter(($this->targetDirs[2].'/Resources/java/yuicompressor.jar'), 'C:\\dev\\java\\jdk\\jdk8-x86\\bin\\java.exe');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListenerService('oc_platform.bigbrother.post_message', array(0 => 'oc_platform.censorship_listener', 1 => 'processMessage'), 0);
     ...
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Form\Type\DatePickerType A OC\PlatformBundle\Form\Type\DatePickerType instance.
     */
    protected function getForm_Type_DatepickerService()
    {
        return $this->services['form.type.datepicker'] = new \OC\PlatformBundle\Form\Type\DatePickerType();
    }
    ...
    /**
     * Gets the 'oc_platform.beta.html' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Beta\BetaHTML A OC\PlatformBundle\Beta\BetaHTML instance.
     */
    protected function getOcPlatform_Beta_HtmlService()
    {
        return $this->services['oc_platform.beta.html'] = new \OC\PlatformBundle\Beta\BetaHTML();
    }
    ...
    {
        return $this->services['oc_platform.beta.listener'] = new \OC\PlatformBundle\Beta\BetaListener($this->get('oc_platform.beta.html'), '2013-10-20');
    }

    /**
     * Gets the 'oc_platform.censorship_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Bigbrother\CensorshipListener A OC\PlatformBundle\Bigbrother\CensorshipListener instance.
     */
    protected function getOcPlatform_CensorshipListenerService()
    {
        return $this->services['oc_platform.censorship_listener'] = new \OC\PlatformBundle\Bigbrother\CensorshipListener($this->get('oc_platform.censorship_processor'), array(0 => 1, 1 => 2, 2 => 4));
    }

    /**
     * Gets the 'oc_platform.censorship_processor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Bigbrother\CensorshipProcessor A OC\PlatformBundle\Bigbrother\CensorshipProcessor instance.
     */
    protected function getOcPlatform_CensorshipProcessorService()
    {
        return $this->services['oc_platform.censorship_processor'] = new \OC\PlatformBundle\Bigbrother\CensorshipProcessor($this->get('swiftmailer.mailer.default'));
    }

    /**
     * Gets the 'oc_platform.ckeditor' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Form\Type\CkeditorType A OC\PlatformBundle\Form\Type\CkeditorType instance.
     */
    protected function getOcPlatform_CkeditorService()
    {
        return $this->services['oc_platform.ckeditor'] = new \OC\PlatformBundle\Form\Type\CkeditorType();
    }

    /**
     * Gets the 'oc_platform.datepicker' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \OC\PlatformBundle\Form\Type\DatePickerType A OC\PlatformBundle\Form\Type\DatePickerType instance.
     */
    protected function getOcPlatform_DatepickerService()
    {
        return $this->services['oc_platform.datepicker'] = new \OC\PlatformBundle\Form\Type\DatePickerType();
    }
    ...
    /**
     * Gets the 'oc_platform.json_paramconverter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getOcPlatform_JsonParamconverterService()
    {
        return $this->services['oc_platform.json_paramconverter'] = new \OC\PlatformBundle\ParamConverter\JsonParamConverter();
    }
    ...
    protected function getSensioFrameworkExtra_Converter_ManagerService()
    {
        ...
        $instance->add($this->get('oc_platform.json_paramconverter'), 0, NULL);
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\OC\\PlatformBundle/Resources/translations\\messages.de.yml'), 'de', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\OC\\PlatformBundle/Resources/translations\\messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\OC\\PlatformBundle/Resources/translations\\messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\OC\\PlatformBundle/Resources/translations\\validators.en.yml'), 'en', 'validators');
        $instance->addResource('yml', ($this->targetDirs[3].'\\src\\OC\\PlatformBundle/Resources/translations\\validators.fr.yml'), 'fr', 'validators');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('oc_platform.antispam'));
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('oc_platform_antiflood' => 'oc_platform.validator.antiflood', 'validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique')));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'assetic.filter.yui_css.java' => 'C:\\dev\\java\\jdk\\jdk8-x86\\bin\\java.exe',
